...
@Component({
  ...
  template: `
    <div class="space-y-6">
      ...
      <ng-container *ngIf="!loading(); else loadingMessage">
        ...
        <div class="overflow-hidden">
          <!-- Pagination Controls -->
          <div *ngIf="users().length > 0" class="flex items-center justify-between px-6 py-2">
                  ...
                  <tr *ngFor="let user of users(); trackBy: trackByUserId" class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-2">
                      <div class="text-sm text-gray-900">
                        ...
                        <span
                          *ngIf="!user.station && !user.supplier && isBlueWhaleRole(user.role)"
                          class="font-medium text-blue-600"
                          >{{ 'common.blueWhale' | transloco }}</span
                        >
                      </div>
                    </td>
                    ...
                    <td class="px-6 py-2 text-right text-sm font-medium">
                      <div class="flex items-center justify-end space-x-2">
                        <button
                          type="button"
                          [class]="
                            canEditUser(user) ? 'text-gray-600 hover:text-gray-900' : 'text-gray-300 cursor-not-allowed'
                          "
              ...
              <div class="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span class="ml-1 text-gray-900">
                    ...
                    <span *ngIf="!user.station && !user.supplier && isBlueWhaleRole(user.role)" class="text-blue-600">{{
                      'common.blueWhale' | transloco
                    }}</span>
                  </span>
                </div>
                <div>
    ...
    >
      <app-add-user-form (cancel)="closeAddUserPanel()" (userCreated)="onUserCreated()"> </app-add-user-form>
    </ui-slide-panel>
