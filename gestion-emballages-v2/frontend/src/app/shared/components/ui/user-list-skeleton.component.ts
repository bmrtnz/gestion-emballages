    ...
    <div class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <div class="h-5 w-48 bg-gray-200 rounded animate-pulse mt-2"></div>
        </div>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div *ngIf="showFilters" class="border-t pt-4">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <div *ngFor="let item of [1,2,3,4]" class="space-y-2">
...
export class UserListSkeletonComponent {
  ...
  @Input() headers: string[] = ['Nom', 'Email', 'Rôle', 'Entité', 'Statut', 'Actions'];
