...
/**
 * Manager strategy for fournisseur management
 * Full access to all supplier operations including sites management
 */
export class FournisseurManagerStrategy extends BaseFournisseurManagementStrategy {
  /**
   * Transform fournisseurs data for Manager users
  ...
  /**
   * Get table columns for Manager tree view
   */
  getTableColumns() {
    return [
      {
