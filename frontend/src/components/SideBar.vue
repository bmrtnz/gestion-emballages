...
const allMenuItems = [
  ...
  },
  {
    ...
    roles: ["Gestionnaire", "Station", "Fournisseur"],
  },
  {
    key: "contrats",
    path: "/contrats",
    label: "Contrats Cadre",
        ...
        <li v-for="item in visibleMenuItems" :key="item.key">
          <router-link :to="item.path">
            ...
            <span>
              ...
              <span
                v-if="
                  item.key === 'liste-achat' && listeAchatStore.itemCount > 0
                "
                class="item-count"
              >
      ...
      <li v-for="item in visibleMenuItems" :key="item.key">
        <router-link :to="item.path" @click="emit('close')">
          ...
          <span>
            {{ item.label }}
            <span
              v-if="item.key === 'liste-achat' && listeAchatStore.itemCount > 0"
              class="item-count"
            >
              ({{ listeAchatStore.itemCount }})
            </span>
