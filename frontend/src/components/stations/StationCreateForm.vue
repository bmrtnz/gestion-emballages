  ...
  <form @submit.prevent="handleSubmit">
    <div class="space-y-6">
      ...
      <div>
        ...
        <input type="text" v-model="formState.identifiantInterne" id="identifiantInterne" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" required />
      </div>
      ...
      <div class="border-t pt-4">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input type="text" v-model="formState.contactPrincipal.nom" id="contactNom" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
          </div>
          <div>
            <label for="contactEmail" class="block text-sm font-medium text-gray-700">Email du contact</label>
            <input type="email" v-model="formState.contactPrincipal.email" id="contactEmail" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
          </div>
          <div>
            <label for="contactTelephone" class="block text-sm font-medium text-gray-700">Téléphone du contact</label>
            <input type="tel" v-model="formState.contactPrincipal.telephone" id="contactTelephone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
          </div>
        </div>
      </div>
    </div>
