...
const shouldUseVirtualScrolling = computed(() => {
  return props.useVirtualScrolling && stations.value.length > 100;
});
                  ...
                  <table class="min-w-full table-fixed">
                    <tbody>
                      <tr class="border-t border-gray-200">
                        <td class="min-w-[12rem] whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900">{{ station.nom }}</td>
